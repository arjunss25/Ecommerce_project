                  ...
                  <div className="flex flex-col lg:flex-row lg:space-x-[5rem] ">
                    ...
                    <div className="image-section w-full lg:w-1/3 mb-8 lg:mb-0">
                      <div className="main-image w-full aspect-square relative rounded-2xl overflow-hidden mb-4">
                        <Image src="/main.svg" layout="fill" objectFit="cover" alt="main-product-image" />
                      </div>
                      <div className="sub-images flex space-x-2">
                        {['/mn-1.svg', '/mn-2.svg', '/mn-3.svg', '/mn-4.svg'].map((src, index) => (
                          <div key={index} className="w-1/4 aspect-square relative rounded-lg overflow-hidden">
                            <Image src={src} layout="fill" objectFit="cover" alt={`product-sub-image-${index + 1}`} />
                          </div>
                        ))}
                      </div>
                    </div>
                    ...
                    <div className="product-info w-full lg:w-1/3 mb-8 lg:mb-0">
                      <div className="flex justify-between items-start mb-4">
                        <h1 className="text-3xl font-medium w-[70%] bg-green-500">{items.name}<span className="text-2xl"> 50ml</span></h1>
                        <span className="bg-blue-600 text-white w-[6rem] py-1 flex items-center justify-center rounded-full text-sm font-semibold">60% OFF</span>
                      </div>
                      
                      <div className="flex items-center mb-4">
                        <Star className="w-5 h-5 text-yellow-400 fill-current" />
                        <span className="ml-1 text-sm font-medium">4.9 Rating</span>
                      ...
                      <div className="mb-6">
                        ...
                        {['50ml', '75ml', '150ml', '250ml'].map((size) => (
                              <button key={size} className="w-20 h-16 border border-gray-300 rounded-md flex items-center justify-center text-sm hover:border-blue-500 transition-colors">
                                {size}
                              </button>
                          ))}
                        </div>
                      ...
                      <div className="border border-gray-200 rounded-b-lg p-4 bg-white ">
                        ...
                        <div className="flex items-center mb-4">
                          <div className="w-16 h-16 relative rounded-md overflow-hidden mr-4">
                            <Image src="/main.svg" layout="fill" objectFit="cover" alt="Selected product" />
                          </div>
                          <div>
                        ...
                        <div className="flex justify-between items-center mb-4">
                          <div className="flex items-center border rounded-full">
                            <button onClick={decrementQuantity} className="p-2 hover:bg-gray-100 rounded-full transition-colors">
                              <Minus className="w-4 h-4" />
                            </button>
                            <span className="px-4 font-medium">{quantity}</span>
                            <button onClick={incrementQuantity} className="p-2 hover:bg-gray-100 rounded-full transition-colors">
                              <Plus className="w-4 h-4" />
                            </button>
                          </div>
                          <div className="text-right">
                            <p className="text-gray-400 line-through">₹3,000</p>
                            <p className="font-bold text-lg">Total Price ₹2000</p>
                          </div>
                        </div>
